...
class Coinbase(Feed, CoinbaseRestMixin):
    ...
    async def _ticker(self, msg: dict, timestamp: float):
        ...
        await self.callback(TICKER, Ticker(self.id, symbol, Decimal(msg['best_bid']), Decimal(msg['best_ask']), self.timestamp_normalize(msg['time']), raw=msg), timestamp, **extra_fields)
